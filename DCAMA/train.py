...
def train(epoch, model, dataloader, optimizer, training):
    ...
    model.module.train_mode() if training else model.eval()
...
if __name__ == '__main__':
    ...
    # model = DCAMA(args.backbone, args.feature_extractor_path, False).to(device)
    _model = DCAMA(args.backbone, args.feature_extractor_path, False).cuda()
